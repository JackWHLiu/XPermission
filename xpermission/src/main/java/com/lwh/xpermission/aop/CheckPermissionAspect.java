...
package com.lwh.xpermission.aop;
...
import com.lwh.xpermission.annotation.CheckPermission;
...
public class CheckPermissionAspect {
    ...
    @Pointcut("execution(@com.lwh.xpermission.annotation.CheckPermission * *(..)) && @annotation(permission)")
